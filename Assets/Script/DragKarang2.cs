...
public class DragKarang2 : MonoBehaviour
{
    ...
    void OnMouseUp()
    {
        ...
        if (!isDropped)
        {
            ...
            foreach (Collider2D collider in colliders)
            {
                ...
                if (collider.CompareTag("DropAreaKarang2"))
                {
                    ...
                    kerangkaManager.checkImageKarang2.SetActive(true);
                    kerangkaManager.Invoke("DelayedObjectiveActions3", 0.5f);
                    break;
                }
            }
