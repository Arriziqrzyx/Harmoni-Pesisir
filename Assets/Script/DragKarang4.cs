...
public class DragKarang4 : MonoBehaviour
{
    ...
    void OnMouseUp()
    {
        ...
        if (!isDropped)
        {
            ...
            foreach (Collider2D collider in colliders)
            {
                ...
                if (collider.CompareTag("DropAreakarang4"))
                {
                    ...
                    kerangkaManager.checkImageKarang4.SetActive(true);
                    kerangkaManager.Invoke("DelayedObjectiveActions5", 0.5f);
                    break;
                }
            }
