...
public class DragKarang6 : MonoBehaviour
{
    ...
    void OnMouseUp()
    {
        ...
        if (!isDropped)
        {
            ...
            foreach (Collider2D collider in colliders)
            {
                ...
                if (collider.CompareTag("DropAreakarang6"))
                {
                    ...
                    kerangkaManager.checkImageKarang6.SetActive(true);
                    kerangkaManager.Invoke("DelayedObjectiveActions7", 0.5f);
                    break;
                }
            }
