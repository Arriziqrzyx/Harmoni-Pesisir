...
public class SeaCleanManager : MonoBehaviour
{
    ...
    {
        seaweedInfoText.text = "Rumput laut liar dibersihkan " + seaweedCleanedCount + "/" + totalSeaweedCount;
    }

    // Metode untuk memperbarui teks informasi trash
    private void UpdateTrashInfoText()
    {
        trashInfoText.text = "Sampah dibersihkan " + trashCleanedCount + "/" + totalTrashCount;
    }
